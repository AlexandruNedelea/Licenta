...
public class EmployeeHouseKeepingAdapter extends RecyclerView.Adapter<UserDetailsViewHolder> {
    private List<UserDetailsModel> modelsList;

    public EmployeeHouseKeepingAdapter(List<UserDetailsModel> modelsList){
